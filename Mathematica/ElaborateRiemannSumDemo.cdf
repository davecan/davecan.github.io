...
NotebookDataLength[     13734,        289]
NotebookOptionsPosition[     13995,        280]
NotebookOutlinePosition[     14509,        301]
CellTagsIndexPosition[     14466,        298]
WindowFrame->Normal*)
...
Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`fn$$ = $CellContext`x^5, $CellContext`ht$$ \
= $CellContext`Midpoint, $CellContext`n$$ = 61, $CellContext`pt$$ = Random, 
...
WindowSize->{424, 559},
WindowMargins->{{408, Automatic}, {Automatic, 74}},
...
(*NotebookFileOutline
Notebook[{
Cell[1235, 30, 12756, 248, 547, "Output"]
}
]
*)
...
(* NotebookSignature fwTpfQqHO2GLeA118zhxysbn *)
