...
NotebookDataLength[      5535,        147]
NotebookOptionsPosition[      5809,        138]
NotebookOutlinePosition[      6311,        159]
CellTagsIndexPosition[      6268,        156]
WindowFrame->Normal*)
  ...
  StyleBox[
   DynamicModuleBox[{$CellContext`a$$ = 2, $CellContext`b$$ = 3, 
    ...
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`a$$], 2}, 0.01, 4}, {{
       Hold[$CellContext`b$$], 3}, 0.01, 4}}, Typeset`size$$ = {
    188., {90., 97.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`a$5433$$ = 
    0, $CellContext`b$5434$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`a$$ = 2, $CellContext`b$$ = 3}, 
      "ControllerVariables" :> {
        Hold[$CellContext`a$$, $CellContext`a$5433$$, 0], 
        Hold[$CellContext`b$$, $CellContext`b$5434$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Graphics[{
          Arrowheads[0], 
          $CellContext`ledge[{0, 0}, {-2, -2}, "base"], 
          $CellContext`ledge[{0, 0}, {2, -2}, "exp"], 
          $CellContext`op[
           TableForm[{
             Style["Power\n", LineSpacing -> {0, 1}], 
             PaddedForm[$CellContext`a$$^$CellContext`b$$, 4]}], {0, 0}, 55], 
          $CellContext`op[$CellContext`a$$, {-2, -2}, 45], 
          $CellContext`op[$CellContext`b$$, {2, -2}, 45]}, ImageSize -> 150, 
         AspectRatio -> 0.8, PlotRange -> {{-4.5, 4.5}, Automatic}]], 
      "Specifications" :> {{{$CellContext`a$$, 2}, 0.01, 
         4}, {{$CellContext`b$$, 3}, 0.01, 4}}, 
...
(*NotebookFileOutline
Notebook[{
Cell[1235, 30, 4570, 106, 311, "Output"]
}
]
*)
...
(* NotebookSignature kx0QgTL7qp0DKA13L6Kap@WN *)
