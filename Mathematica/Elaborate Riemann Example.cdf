...
NotebookDataLength[     13417,        285]
NotebookOptionsPosition[     13724,        277]
NotebookOutlinePosition[     14192,        297]
CellTagsIndexPosition[     14149,        294]
WindowFrame->Normal*)
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`fn$$ = (1 - $CellContext`x^2)^
    ...
    False, $CellContext`n$778$$ = 0, $CellContext`pt$779$$ = 
    False, $CellContext`ht$780$$ = 0, $CellContext`fn$781$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`fn$$ = (1 - $CellContext`x^2)^
         Rational[
          1, 2], $CellContext`ht$$ = $CellContext`Midpoint, $CellContext`n$$ = 
        1, $CellContext`pt$$ = $CellContext`Uniform}, "ControllerVariables" :> {
        Hold[$CellContext`n$$, $CellContext`n$778$$, 0], 
        Hold[$CellContext`pt$$, $CellContext`pt$779$$, False], 
        Hold[$CellContext`ht$$, $CellContext`ht$780$$, 0], 
        Hold[$CellContext`fn$$, $CellContext`fn$781$$, 0]}, 
      "OtherVariables" :> {
...
$CellContext`n$$}], 
      "Specifications" :> {{{$CellContext`n$$, 1}, 1, 100, 
...
$CellContext`list = {{0., 1.}, 1.}, $CellContext`UniformPartition[
         Pattern[$CellContext`range, 
          Blank[]], 
...
$CellContext`partitionstring = 
       "Uniform partition into 1 subintervals", $CellContext`RandomPartition[
         Pattern[$CellContext`range, 
          Blank[]], 
...
(*NotebookFileOutline
Notebook[{
Cell[1235, 30, 12485, 245, 521, "Output"]
}
]
*)
...
(* NotebookSignature evpEXvkzeJK29DgqplbZC4XE *)
