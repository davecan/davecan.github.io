...
NotebookDataLength[      7381,        180]
NotebookOptionsPosition[      7822,        172]
NotebookOutlinePosition[      8385,        195]
CellTagsIndexPosition[      8342,        192]
WindowFrame->Normal*)
...
Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`s$$ = 2, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`s$$], 1, "Examples"}, {1, 2, 3, 4, 5, 6, 7, 8}}}, 
    Typeset`size$$ = {350., {85., 88.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`s$2128$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, "Variables" :> {$CellContext`s$$ = 1}, 
      "ControllerVariables" :> {
        Hold[$CellContext`s$$, $CellContext`s$2128$$, 0]}, 
      "OtherVariables" :> {
...
$CellContext`labelsty[
           ...
           "join insides"], $CellContext`lab3 = $CellContext`labelsty[
...
WindowSize->{396, 242},
WindowMargins->{{633, Automatic}, {Automatic, 364}},
Visible->True,
AuthoredSize->{396.44, 242.05},
...
(*NotebookFileOutline
Notebook[{
Cell[1463, 33, 6355, 137, 235, "Output"]
}
]
*)
...
(* NotebookSignature YvTd4sF98r59AB1ayHCpPHI7 *)
