...
NotebookDataLength[     10849,        260]
NotebookOptionsPosition[     11123,        251]
NotebookOutlinePosition[     11625,        272]
CellTagsIndexPosition[     11582,        269]
WindowFrame->Normal*)
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`n1$$ = 8234, $CellContext`n2$$ = 
    ...
    333., {64., 71.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`n1$4628$$ = 
    0, $CellContext`n2$4629$$ = 0, $CellContext`n3$4630$$ = 
    0, $CellContext`n4$4631$$ = 0, $CellContext`n5$4632$$ = 
    0, $CellContext`seats$4633$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`n1$$ = 8234, $CellContext`n2$$ = 
        ...
        4356, $CellContext`n5$$ = 2390, $CellContext`seats$$ = 10}, 
      "ControllerVariables" :> {
        Hold[$CellContext`n1$$, $CellContext`n1$4628$$, 0], 
        Hold[$CellContext`n2$$, $CellContext`n2$4629$$, 0], 
        Hold[$CellContext`n3$$, $CellContext`n3$4630$$, 0], 
        Hold[$CellContext`n4$$, $CellContext`n4$4631$$, 0], 
        Hold[$CellContext`n5$$, $CellContext`n5$4632$$, 0], 
        Hold[$CellContext`seats$$, $CellContext`seats$4633$$, 0]}, 
      "OtherVariables" :> {
...
$CellContext`preshow[
         ...
         Pattern[$CellContext`seats, 
          Blank[]]] := 
       Module[{$CellContext`q = $CellContext`squota[$CellContext`list, \
...
$CellContext`seats]}, 
         Map[If[Part[
             Part[$CellContext`eap, #], 3] == 0, "not app", 
           N[Part[
              Part[$CellContext`eap, #], 2]/Part[
             Part[$CellContext`eap, #], 3]]]& , 
          Part[
           Transpose[$CellContext`eap], 1]]], $CellContext`bfformathead[
         Pattern[$CellContext`l, 
          Blank[]]] := 
...
WindowSize->{384.78000000000003`, 481.01},
...
(*NotebookFileOutline
Notebook[{
Cell[1235, 30, 9884, 219, 467, "Output"]
}
]
*)
...
(* NotebookSignature 4wTYxnySZMBH5DgEulPH36xI *)
