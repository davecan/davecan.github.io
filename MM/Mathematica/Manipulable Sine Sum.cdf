...
NotebookDataLength[     12901,        280]
NotebookOptionsPosition[     13208,        272]
NotebookOutlinePosition[     13676,        292]
CellTagsIndexPosition[     13633,        289]
WindowFrame->Normal*)
...
$CellContext`n$$ = 4, $CellContext`pt$$ = $CellContext`Uniform, 
    ...
    False, $CellContext`n$9956$$ = 0, $CellContext`pt$9957$$ = 
    False, $CellContext`ht$9958$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`ht$$ = $CellContext`Midpoint, \
$CellContext`n$$ = 4, $CellContext`pt$$ = $CellContext`Uniform}, 
      "ControllerVariables" :> {
        Hold[$CellContext`n$$, $CellContext`n$9956$$, 0], 
        Hold[$CellContext`pt$$, $CellContext`pt$9957$$, False], 
        Hold[$CellContext`ht$$, $CellContext`ht$9958$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> $CellContext`PlotRiemann[
        Sin[Pi $CellContext`x], {$CellContext`x, 0, 1}, {
        ImageSize -> {350, 350}}, {
...
(*NotebookFileOutline
Notebook[{
Cell[1235, 30, 11969, 240, 491, "Output"]
}
]
*)
...
(* NotebookSignature PwTsIWT2R@3@7CK4Lx67Ctkh *)
