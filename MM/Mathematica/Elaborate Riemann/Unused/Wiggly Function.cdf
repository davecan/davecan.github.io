...
NotebookDataLength[     12285,        268]
NotebookOptionsPosition[     12636,        258]
NotebookOutlinePosition[     13289,        283]
CellTagsIndexPosition[     13246,        280]
WindowFrame->Normal*)
...
Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`n$$ = 19.999999999999975`, Typeset`show$$ = 
    True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`n$$], 20}, 1, 100}}, Typeset`size$$ = {
    438., {215., 223.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`n$93668$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, "Variables" :> {$CellContext`n$$ = 20}, 
      "ControllerVariables" :> {
        Hold[$CellContext`n$$, $CellContext`n$93668$$, 0]}, 
      "OtherVariables" :> {
...
WindowSize->{533, 588},
WindowMargins->{{407, Automatic}, {Automatic, 18}},
Visible->True,
AuthoredSize->{533, 613},
...
(*NotebookFileOutline
Notebook[{
Cell[1464, 33, 11168, 223, 595, "Output"]
}
]
*)
...
(* NotebookSignature ivTlr3ptZZtDaBgoO5tTetYH *)
