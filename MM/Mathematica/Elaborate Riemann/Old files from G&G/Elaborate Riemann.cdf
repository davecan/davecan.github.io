...
NotebookDataLength[     13981,        298]
NotebookOptionsPosition[     14333,        288]
NotebookOutlinePosition[     14985,        313]
CellTagsIndexPosition[     14942,        310]
WindowFrame->Normal*)
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`fn$$ = (1 - $CellContext`x^2)^
    ...
    False, $CellContext`n$549$$ = 0, $CellContext`pt$550$$ = 
    False, $CellContext`ht$551$$ = 0, $CellContext`fn$552$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`fn$$ = (1 - $CellContext`x^2)^
        ...
        Hold[$CellContext`n$$, $CellContext`n$549$$, 0], 
        Hold[$CellContext`pt$$, $CellContext`pt$550$$, False], 
        Hold[$CellContext`ht$$, $CellContext`ht$551$$, 0], 
        Hold[$CellContext`fn$$, $CellContext`fn$552$$, 0]}, 
      "OtherVariables" :> {
...
$CellContext`n$$}], 
      "Specifications" :> {{{$CellContext`n$$, 4}, 1, 100, 1, Appearance -> 
...
(*NotebookFileOutline
Notebook[{
Cell[1464, 33, 12865, 253, 723, "Output"]
}
]
*)
...
(* NotebookSignature jxT3EyRWPw3mWDwNbLK0pwjy *)
