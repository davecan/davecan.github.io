...
NotebookDataLength[     13618,        290]
NotebookOptionsPosition[     13990,        281]
NotebookOutlinePosition[     14622,        305]
CellTagsIndexPosition[     14579,        302]
WindowFrame->Normal*)
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`fn$$ = (1 - $CellContext`x^2)^
    ...
    False, $CellContext`n$6306$$ = 0, $CellContext`pt$6307$$ = 
    False, $CellContext`ht$6308$$ = 0, $CellContext`fn$6309$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`fn$$ = (1 - $CellContext`x^2)^
        ...
        Hold[$CellContext`n$$, $CellContext`n$6306$$, 0], 
        Hold[$CellContext`pt$$, $CellContext`pt$6307$$, False], 
        Hold[$CellContext`ht$$, $CellContext`ht$6308$$, 0], 
        Hold[$CellContext`fn$$, $CellContext`fn$6309$$, 0]}, 
      "OtherVariables" :> {
...
WindowSize->{429, 547},
WindowMargins->{{459, Automatic}, {Automatic, 39}},
Visible->True,
AuthoredSize->{429, 572},
...
(*NotebookFileOutline
Notebook[{
Cell[1464, 33, 12522, 246, 555, "Output"]
}
]
*)
...
(* NotebookSignature 0xTd4U52K0yT3A1Kekdqc#RM *)
