...
NotebookDataLength[     13108,        281]
NotebookOptionsPosition[     13415,        273]
NotebookOutlinePosition[     13883,        293]
CellTagsIndexPosition[     13840,        290]
WindowFrame->Normal*)
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`fn$$ = (1 - $CellContext`x^2)^
    ...
    False, $CellContext`n$1328$$ = 0, $CellContext`pt$1333$$ = 
    False, $CellContext`ht$1334$$ = 0, $CellContext`fn$1335$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`fn$$ = (1 - $CellContext`x^2)^
        ...
        Hold[$CellContext`n$$, $CellContext`n$1328$$, 0], 
        Hold[$CellContext`pt$$, $CellContext`pt$1333$$, False], 
        Hold[$CellContext`ht$$, $CellContext`ht$1334$$, 0], 
        Hold[$CellContext`fn$$, $CellContext`fn$1335$$, 0]}, 
      "OtherVariables" :> {
      ...
      "Body" :> $CellContext`PlotRiemann[$CellContext`fn$$, {$CellContext`x, 
         0, 1}, {ImageSize -> {350, 350}, AspectRatio -> 1}, {
...
$CellContext`arealist}], $CellContext`ShowSlices[
...
(*NotebookFileOutline
Notebook[{
Cell[1235, 30, 12176, 241, 521, "Output"]
}
]
*)
...
(* NotebookSignature Ewp6p@nFdSUYeB1kO6x47sXB *)
